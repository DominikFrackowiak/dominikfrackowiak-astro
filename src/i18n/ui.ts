...
export const ui = {
 en: {
  ...
  'experience.description.softcollie': 'Co-developing a large ERP application and its frontend architecture. Building interfaces and developer workflows with AI-assisted tooling.',
